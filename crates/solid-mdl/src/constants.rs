...
pub const ANORMS_COUNT: usize = 162;

pub static ANORMS: [Vec3; ANORMS_COUNT] = [
...
pub fn find_closest_anorm(normal: Vec3) -> u8 {
    let mut best = 0u8;
    let mut best_dot = -2.0f32;
    for (i, a) in ANORMS.iter().enumerate() {
