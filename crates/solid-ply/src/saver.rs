...
fn write_ascii(
    ...
    for v in &geom.vertices {
        let p = v.position;
        if use_double {
            write!(w, "{} {} {}", p.x as f64, p.y as f64, p.z as f64).map_err(SolidError::Io)?;
        } else {
        ...
        if geom.has_tangents {
            ...
            if use_double {
                write!(
                    w,
                    " {} {} {} {}",
                    t.x as f64, t.y as f64, t.z as f64, t.w as f64
                )
                .map_err(SolidError::Io)?;
            } else {
